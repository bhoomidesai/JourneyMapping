...
<body>
<div style="background-color: white;font-family: sans-serif;font-size: x-large; color:navy;text-align: center ; ; padding: 10px;"><b>Welcome to Student Journey Mapping</b></div>
<div class="timeline">
